...
for year in years: 
    ...
    dataframe_10k.to_csv('C:\\Users\\Shreya Sainathan\\Downloads\\details_10k.csv')
...
for i in range(len(dataframe_10k)) : 
    ...
    clean_txt = remove_html_tags(decoded_html)
    ...
    if(len(x)!=0):
        ...
        counts_dataframe = pd.DataFrame.from_dict(counts_dictionary)
